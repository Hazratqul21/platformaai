...
plus:'<path d="M12 5v14M5 12h14"/>',clock:'<circle cx="12" cy="12" r="9"/><path d="M12 7.5v5l3.2 2"/>',
...
const DICT = {
  'uz_lat': {
    'smeta': "Yangi zakaz (smeta)", 'smeta_sub': "O'lcham → tannarx → taklif narxi",
    ...
    'orders': "Buyurtmalar", 'orders_sub': "Status treker: Kutishda -> Sexda -> Omborda -> Mijozda",
    'wh': "Ombor", 'wh_sub': "Xomashyo partiyalari va tayyor mahsulot",
    'calc': "Yangi zakaz (smeta)", 'calc_sub': "O'lcham → m² → tannarx → taklif narxi",
  ...
  'uz_cyr': {
    'smeta': "Янги заказ (смета)", 'smeta_sub': "Ўлчам → таннарх → таклиф нархи",
    ...
    'orders': "Буюртмалар", 'orders_sub': "Статус трекер: Кутишда -> Цехда -> Омборда -> Мижозда",
    'wh': "Омбор", 'wh_sub': "Хомашё партиялари ва тайёр маҳсулот",
    'calc': "Янги заказ (смета)", 'calc_sub': "Ўлчам → м² → таннарх → таклиф нархи",
  ...
  'ru': {
    'smeta': "Новый заказ (смета)", 'smeta_sub': "Размер → себестоимость → цена",
    ...
    'orders': "Заказы", 'orders_sub': "Статус трекер: Ожидание -> В цеху -> На складе -> У клиента",
    'wh': "Склад", 'wh_sub': "Партии сырья и готовая продукция",
    'calc': "Новый заказ (смета)", 'calc_sub': "Размер → м² → себестоимость → цена",
